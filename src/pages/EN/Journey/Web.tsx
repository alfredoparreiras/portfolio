    ...
    <section className="hidden lg:block">
      <div className="flex w-full justify-evenly lg:pt-4">
        <div className=" w-[45%] xlg:w-[30%]">
          ...
          <div
            className="text-[1.150rem] leading-9
                            xlg:text-[1.5rem]"
          >
            <p className="mb-3 mt-5">
              Hi, I'm Alfredo, a proud Brazilian currently living in the vibrant
              city of Montreal. I'm happily married to Carol and deeply
              connected with my Christian faith.
            </p>
            <p className="mb-3">
              As a focused developer, my excitement lies in exploring new
              technologies and broadening the scope of digital discovery. You
              can find my actual stack below.
            </p>
            <p className="mb-3">
              ...
              return (
                <div key={index} className="">
                  <div className="flex flex-col items-center">
                    <Icons skill={item} darkMode={darkMode} />
