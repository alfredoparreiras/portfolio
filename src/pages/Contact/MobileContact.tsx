...
const MobileContact = () => {
  return (
    <section id="contact" className="mt-16 h-screen px-12">
      ...
      <div className="flex h-1/4 flex-col items-center justify-center">
        ...
        <div className="flex">
          <div>
            <a
              href="https://github.com/alfredoparreiras"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
                className="h-16 w-16 fill-black hover:fill-accentColor"
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/alfredopsilva/"
              target="_blank"
              rel="noopener noreferrer" // It's good practice to include this for security reasons
            >
              {/* Linkedin */}
              <svg
                className="h-16 w-16 fill-black hover:fill-accentColor"
